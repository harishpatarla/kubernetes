...
#Log out of the node and onto c1-master1
exit


#Back on c1-master1, is c1-node1 reporting Ready?
kubectl get nodes
...
#On c1-master1, c1-node2 should be Ready. 
kubectl get nodes
...
#Log out and back into c1-master1
exit
